...
export const About = () => {
  ...
  return (
    <section id="about" className="veda-section-padding bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-6">
              {["Python", "AI/ML", "Robotics", "Cloud Computing", "Arduino", "Computer Vision"].map((skill) => (
                <span key={skill} className="bg-secondary text-secondary-foreground rounded-full px-4 py-2 text-sm font-medium border border-border">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className="space-y-6">
            {highlights.map((item, index) => (
              <Card key={index} className="veda-card card-hover">
